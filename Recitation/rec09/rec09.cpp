/*
    ...
    CS2124 - Sec C
    Hongyi Zheng
    NOTE I first write my own code. However, to make sure that I could check if
    I complete later tasks correctly, I change my code to the standard answer
    provided after completion of every single task.
 */
...
public:
    TextBook(unsigned numOfPages, unsigned numOfIndexPages)
...
public:
    ...
    void displayNumPages() const {
        ...
        cout << "=====================================\n"
             ...
             << "   single one of them!\n"
             << "    And now, let's let the quest continue..." << endl
             << endl
             << endl;
    }
...
void displayNumPages(const PrintedMaterial& pm) { pm.displayNumPages(); }
